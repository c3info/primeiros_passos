...
def addsitepackages(known_paths):
    ...
    buildout_paths = [
        ...
        '/srv/cache/eggs/Products.PrintingMailHost-0.7-py2.7.egg',
        '/srv/primeiros_passos/src/collective.cover/src',
        '/srv/cache/eggs/Products.PloneFormGen-1.7.12-py2.7.egg',
        '/srv/cache/eggs/plone.app.workflowmanager-1.0a4-py2.7.egg',
        '/srv/primeiros_passos/src/brasil.gov.barra/src',
        '/srv/primeiros_passos/src/beyondskins.responsive',
        ...
        '/srv/cache/eggs/collective.js.jqueryui-1.10.1.2-py2.7.egg',
        '/srv/cache/eggs/plone.app.jquerytools-1.5.5-py2.7.egg',
        '/srv/cache/eggs/Products.PythonField-1.1.3-py2.7.egg',
        '/srv/cache/eggs/Products.TemplateFields-1.2.5-py2.7.egg',
        '/srv/cache/eggs/Products.TALESField-1.1.3-py2.7.egg',
        ...
        '/srv/cache/eggs/plone.tiles-1.2-py2.7.egg',
        ...
        '/srv/cache/eggs/plone.directives.form-2.0-py2.7.egg',
        '/srv/cache/eggs/plone.dexterity-2.1.3-py2.7.egg',
        '/srv/cache/eggs/plone.app.tiles-1.0.1-py2.7.egg',
        '/srv/cache/eggs/plone.app.textfield-1.2.2-py2.7.egg',
        '/srv/cache/eggs/plone.app.stagingbehavior-0.1b4-py2.7.egg',
        '/srv/cache/eggs/plone.app.registry-1.2.3-py2.7.egg',
        '/srv/cache/eggs/plone.app.lockingbehavior-1.0.1-py2.7.egg',
        '/srv/cache/eggs/plone.app.dexterity-2.0.8-py2.7.egg',
        '/srv/cache/eggs/plone.app.blocks-1.1.1-py2.7.egg',
        '/srv/cache/eggs/five.grok-1.3.2-py2.7.egg',
        '/srv/cache/eggs/collective.js.galleria-1.2.5-py2.7.egg',
        ...
        '/srv/cache/eggs/zope.app.publisher-3.10.2-py2.7.egg',
        ...
        '/srv/cache/eggs/grokcore.view-2.7-py2.7.egg',
        ...
        '/srv/cache/eggs/plone.app.drafts-1.0a2-py2.7.egg',
        '/srv/cache/eggs/z3c.relationfield-0.6.2-py2.7.egg',
        '/srv/cache/eggs/plone.app.relationfield-1.2.1-py2.7.egg',
        '/srv/cache/eggs/plone.app.z3cform-0.7.3-py2.7.egg',
        '/srv/cache/eggs/plone.app.intid-1.0.2-py2.7.egg',
        '/srv/cache/eggs/plone.directives.dexterity-1.0.2-py2.7.egg',
        ...
        '/srv/cache/eggs/grokcore.viewlet-1.10.1-py2.7.egg',
        '/srv/cache/eggs/grokcore.site-1.6.1-py2.7.egg',
        '/srv/cache/eggs/grokcore.security-1.6.2-py2.7.egg',
        '/srv/cache/eggs/grokcore.component-2.5-py2.7.egg',
        '/srv/cache/eggs/grokcore.annotation-1.3-py2.7.egg',
        '/srv/cache/eggs/martian-0.14-py2.7.egg',
        ...
        '/srv/cache/eggs/rwproperty-1.0-py2.7.egg',
        '/srv/cache/eggs/zc.relation-1.0-py2.7.egg',
        '/srv/cache/eggs/z3c.objpath-1.1-py2.7.egg',
        '/srv/cache/eggs/zope.app.container-3.9.2-py2.7.egg',
        '/srv/cache/eggs/zope.app.intid-3.7.1-py2.7.egg',
        '/srv/cache/eggs/plone.formwidget.contenttree-1.0.6-py2.7.egg',
        '/srv/cache/eggs/z3c.formwidget.query-0.9-py2.7.egg',
        '/srv/cache/eggs/five.intid-1.0.3-py2.7.egg',
        '/srv/cache/eggs/zope.intid-3.7.2-py2.7.egg',
        ...
        '/srv/cache/eggs/zope.dublincore-3.7.0-py2.7.egg',
        '/srv/cache/eggs/zope.copypastemove-3.7.0-py2.7.egg',
        '/srv/cache/eggs/plone.formwidget.autocomplete-1.2.4-py2.7.egg',
        '/srv/cache/eggs/zope.keyreference-3.6.4-py2.7.egg'
        ]
